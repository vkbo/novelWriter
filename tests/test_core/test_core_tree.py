...
def testCoreTree_XMLPackUnpack(mockGUI, mockItems):
    ...
    assert etree.tostring(nwXML, pretty_print=False, encoding="utf-8") == (
        b'<novelWriterXML>'
        b'<content count="8">'
        b'<item handle="a000000000001" order="0" parent="None" type="ROOT" class="NOVEL">'
        b'<meta expanded="True"/><name status="None">Novel</name></item>'
        b'<item handle="b000000000001" order="0" parent="a000000000001" type="FOLDER" '
        b'class="NOVEL"><meta expanded="True"/><name status="None">Act One</name></item>'
        b'<item handle="c000000000001" order="0" parent="b000000000001" type="FILE" class="NOVEL" '
        b'layout="DOCUMENT"><meta exported="True" charCount="300" wordCount="50" paraCount="2" '
        b'cursorPos="0"/><name status="None">Chapter One</name></item>'
        b'<item handle="c000000000002" order="0" parent="b000000000001" type="FILE" class="NOVEL" '
        b'layout="DOCUMENT"><meta exported="True" charCount="3000" wordCount="500" paraCount="20" '
        b'cursorPos="0"/><name status="None">Scene One</name></item>'
        b'<item handle="a000000000002" order="0" parent="None" type="ROOT" class="ARCHIVE">'
        b'<meta expanded="False"/><name status="None">Outtakes</name></item>'
        b'<item handle="a000000000003" order="0" parent="None" type="TRASH" class="TRASH">'
        b'<meta expanded="False"/><name status="None">Trash</name></item>'
        b'<item handle="a000000000004" order="0" parent="None" type="ROOT" class="CHARACTER">'
        b'<meta expanded="True"/><name status="None">Characters</name></item>'
        b'<item handle="b000000000002" order="0" parent="a000000000002" type="FILE" '
        b'class="CHARACTER" layout="NOTE"><meta exported="True" charCount="2000" wordCount="400" '
        b'paraCount="16" cursorPos="0"/><name status="None">Jane Doe</name></item>'
        b'</content>'
        b'</novelWriterXML>'
    )
