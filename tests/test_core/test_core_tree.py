...
def testCoreTree_XMLPackUnpack(mockGUI, mockItems):
    ...
    assert etree.tostring(nwXML, pretty_print=False, encoding="utf-8") == (
        ...
        b'import="i000004" exported="True">Chapter One</name></item>'
        ...
        b'import="i000004" exported="True">Scene One</name></item>'
        ...
        b'import="i000004" exported="True">Jane Doe</name></item>'
        b'</content>'
        b'</novelWriterXML>'
    )
