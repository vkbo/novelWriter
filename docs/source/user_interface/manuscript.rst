...
.. tip::
   ...
   and just hit the :guilabel:`Apply` button to update the preview in the main
   **Manuscript Build** window. When you're happy with the result, you can close the settings.
