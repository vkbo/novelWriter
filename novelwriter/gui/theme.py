...
class GuiTheme:
    ...
    def loadTheme(self, *, schemeHint: Any | None = None, force: bool = False) -> bool:
        ...
        if section := data.get("Icon"):
            ...
            self._setBaseColor("action2", self._readColor(section, "altAction"))
            ...
            self._setBaseColor("system", self._readColor(section, "systemIO"))
    ...
    def _resetTheme(self) -> None:
        ...
        self._setBaseColor("action2", orange)
